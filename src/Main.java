...
public class Main {
    public static void main(String[] args) {
        ...
        while (choice != 8) {
            ...
            System.out.println("6. Clear Regular Customer Cart");
            System.out.println("7. View VIP Customer Benefits");
            ...
            switch (choice) {
                ...
                case 5:
                    checkout.processCheckout(customer1);

                    if (!customer1.getCart().isEmpty()) {
                        System.out.print("Confirm purchase? (yes/no): ");
                        String confirm = scanner.nextLine();

                        if (confirm.equalsIgnoreCase("yes")) {
                            checkout.completePurchase(customer1);
                        } else {
